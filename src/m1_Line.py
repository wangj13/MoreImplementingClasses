...
class Line(object):
    ...
    def length(self):
        ...
        Type hints:
          :rtype: float
        """
        y_squared = (self.end.y-self.start.y)**2
        x_squared = (self.end.x-self.start.x)**2
        d = math.sqrt(y_squared + x_squared)
        return d
        # --------------------------------------------------------------
        # DONE: 7.
        #   a. READ the above specification, including the Example.
    ...
    def line_plus(self, other_line):
        ...
        Type hints:
          ...
          :rtype: Line:
        """
        return Line(Point.plus(self.start, other_line.start), Point.plus(
    ...
    def line_minus(self, other_line):
        ...
        Type hints:
          ...
          :rtype: Line:
        """
        return Line(Point.minus(self.start, other_line.start), Point.minus(
                    self.end, other_line.end))
        # --------------------------------------------------------------
        # DONE: 10.
        #   a. READ the above specification, including the Example.
    ...
    def reset(self):
        ...
        """
        self.start = self.initials
        self.end = self.initiale
        # --------------------------------------------------------------
        # DONE: 13.
        #   a. READ the above specification, including the Example.
        #        ** ASK QUESTIONS AS NEEDED. **
