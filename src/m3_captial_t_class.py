...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        """
        point1 = rg.Point(intersection_center.x-width/2,
                          intersection_center.y-letter_thickness/2)
        point2 = rg.Point(intersection_center.x+width/2,
                          intersection_center.y+letter_thickness/2)
        self.h_rect = rg.Rectangle(point1, point2)


        point3 = rg.Point(intersection_center.x-letter_thickness/2,
                          intersection_center.y-letter_thickness/2)
        point4 = rg.Point(intersection_center.x+letter_thickness/2,
